...
//       uploadFile(videoThumbnail, "imgUrl");
...
//         const progress =
//           (snapshot.bytesTransferred / snapshot.totalBytes) * 100;
//         urlType === "imgUrl" ? setImgPrec(progress) : setVideoPrec(progress);
//       },
//       (error) => {
//         toast.error(error.message);
//       },
...
//               accept="video/*"
//               onChange={handleVideoChange}
//               className="block w-full text-sm text-gray-400 bg-gray-950 border-[.5px] border-gray-800 rounded-lg file:bg-gray-700 file:border-none file:text-white file:mr-4 file:py-2 file:px-4 hover:file:bg-gray-600 focus:outline-none focus:border-gray-900"
//               required
//             />
//             {videoPrec > 0 && (
//               <div className="mt-2">
...
//           <button
//             type="submit"
//             className="w-full py-3 px-4 text-lg font-medium text-white bg-indigo-600 rounded-lg hover:bg-indigo-700 focus:outline-none focus:bg-indigo-700"
//           >
//             Upload Video
//           </button>
//         </form>
...
// src/UploadVideoPage.jsx

import React, { useState } from "react";
import { HiOutlinePhotograph } from "react-icons/hi";
import { client, storage } from "../appwrite"; // Import the client and storage instances
...
const UploadVideoPage = () => {
  ...
  //       setImgPrec
  //     );
  //     const videoUrl = await uploadFile(videoFile, videoBucket, setVideoPrec);
  ...
  const uploadFile = async (file, bucketId, setProgress) => {
  ...
  if (uploading) {
    return (
      <h1 className=" min-h-screen text-white flex justify-center items-center">
        Uploading....
      </h1>
    );
  }
